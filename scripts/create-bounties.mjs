...
for (const row of [
  ...
  ['firmware', 'D93F0B', 'ESP32/ESP8266 farmware'],
  ['web', '0E8A16', 'HIRI-web'],
...
const issues = [
  ...
  { title: '[200 MRG] End-to-end: ESP farmware + bridge + HA discovery video', labels: ['bounty', 'bounty: feature', 'firmware', 'bridge', 'ha', 'reward:200-mrg'],
